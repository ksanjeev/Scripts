...
#============================================================================#
  for $i (0..(scalar(@data)-1))
  {
    ...
    #********************************************************************************
    if ( uc($command) eq "RUN")
    {
    # Comment added by Sharad Agarwal on 10th April 2007
    # If the first parameter is run in the input file (GUI.cfg)
    # This will execute the batch file or exe which is mentioned as third argument.
    # The config file should contain in the format;
    # Ex: run,C:\Rx6X_BLD_VIEW\,6.1-Promo-PharmacyBuild.bat
    #********************************************************************************
      chdir($root_path);
      $dir = getcwd;
      chdir($data[$i][1]);
...
#============================================================================#      
  ...
  # Commented by Sharad Agarwal on 26th March 2007.
