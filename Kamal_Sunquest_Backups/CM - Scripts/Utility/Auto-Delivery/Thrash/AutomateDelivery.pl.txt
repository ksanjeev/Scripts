...
####################################################  
   ...
   my $type = ref($args{'cmd'}) or print "Reference to cleartool command not passed to ClearTool";    
   local($_);
   my $x =  ${$args{'cmd'}}; 
...
my $subject = 'Auto Deliver Process Completed Successfully';
...
my $subject = 'Auto Deliver Process Failed !';
