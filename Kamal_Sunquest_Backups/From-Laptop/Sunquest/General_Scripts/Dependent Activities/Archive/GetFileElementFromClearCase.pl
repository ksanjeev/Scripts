...
#      The script gets input from the configuration file ( GetFileElementFromClearCase.CFG ). 
#
#
# Usage:
#       1) Edit the configuration file ( GetFileElementFromClearCase.CFG )
#       2) Run this script at command prompt as 'perl GetFileElementFromClearCase.PL' 
#
#
# Returns:
#      1) It creates folder for each activity specified in the "GetFileElementFromClearCase.CFG" file and copies the associated versions of elements as per the change set.
...
# Edit the below variables as per required
    ...
    my $ConfigFile = 'GetFileElementFromClearCase.CFG';            # Absolute path to the "GetFileElimentFromClearCase.CFG"
    my $ViewTag = 'Test_int_view';
...
#-------------------- Please do not edit below this line -----------------#
  ...
  ##################### Start of Main Program #####################
    ...
    #$Build{DESTINATION_FOLDER} .= 'Obj-Extract\\';
    my $ErrorLog = $Build{DESTINATION_FOLDER}.'Error_GetFileElementFromClearCase.log';  
    my $EventLog = $Build{DESTINATION_FOLDER}.'GetFileElementFromClearCase.log';

    print "\n\n* * * Starting GetFileElementFromClearCase.PL.......* * * \n\n";
