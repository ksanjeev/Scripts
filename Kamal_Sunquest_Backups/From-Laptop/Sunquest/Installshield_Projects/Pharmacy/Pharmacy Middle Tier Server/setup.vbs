...
strtmp1 = strDesktop & "\Pharmacy Server Configuration.lnk"
...
oLink.IconLocation = Session.Property("NEW_DIRECTORY2") + "\Sunquest.ico"

oLink.WorkingDirectory = Session.Property("NEW_DIRECTORY2")
...
strtmp1 = strDesktop & "\Pharmacy Support Console.lnk"

set oLink = oWSHShell.CreateShortcut(strtmp1)

strtmp2 = Session.Property("NEW_DIRECTORY2") + "\RxSupportConsole.exe"
...
strtmp1 = strDesktop & "\Pharmacy Scheduler Manager.lnk"

set oLink = oWSHShell.CreateShortcut(strtmp1)

strtmp2 = Session.Property("NEW_DIRECTORY1") + "\RxSchedulerMgr.exe"
...
oLink.WorkingDirectory = Session.Property("NEW_DIRECTORY1")
...
strtmp1 = strtmp1 & "\Pharmacy Server"
...
strtmp5 = strtmp1 & "\Pharmacy Server Configuration.lnk"
...
strtmp5 = strtmp1 & "\Pharmacy Support Console.lnk"
...
strtmp5 = strtmp1 & "\Pharmacy Scheduler Manager.lnk"
...
strDesktop = oWSHShell.SpecialFolders("AllUsersPrograms") + "\Misys\Hosp\Pharmacy Server"
