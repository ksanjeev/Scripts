...
set msi_view_name=%USERNAME%_MSI_Release_View
...
cleartool mount \cue_baloo
cleartool mount \cuebin1
cleartool mount \ndbuild
cleartool mount \3rdparty3

cleartool setcs -tag %view_name% c:\Baloo\cspec\bt-release-bootstrap.cspec
...
:successBuild
nant /f:psp-release.build -D:logfile=nant_out_msm.log -D:param.access.type=internal -verbose -D:vendor.name=trianz -D:param.buildtype=msm -D:buildResult=Succeeded -D:notify.miscellaneous.list=project-hp-ps-sddev@trianz.com psp.archive.log
...
:failedBuild
nant /f:psp-release.build -D:logfile=nant_out_msm.log -D:param.access.type=internal -verbose -D:vendor.name=trianz -D:param.buildtype=msm -D:buildResult=Failed -D:notify.miscellaneous.list=project-hp-ps-sddev@trianz.com psp.archive.log
